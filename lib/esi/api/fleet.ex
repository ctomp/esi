defmodule ESI.API.Fleet do
  ...
  - `path` -- `/v1/fleets/{fleet_id}/members/{member_id}/`
  ...
  - `path` -- `/v1/fleets/{fleet_id}/wings/{wing_id}/`
  ...
  - `path` -- `/v1/fleets/{fleet_id}/squads/{squad_id}/`
  ...
  - `path` -- `/v1/fleets/{fleet_id}/wings/{wing_id}/squads/`
