defmodule ESI.API.Corporation do
  ...
  - `path` -- `/v1/corporations/{corporation_id}/assets/`
  ...
  - `path` -- `/v1/corporations/{corporation_id}/wallets/{division}/journal/`
  ...
  - `path` -- `/v1/corporations/{corporation_id}/structures/{structure_id}/`
